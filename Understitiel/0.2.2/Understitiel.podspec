Pod::Spec.new do |s|
  ...
  s.license      = "© Copyright 2016 - Koppasoft (http://www.koppasoft.com/)"
  # s.license    = { :type => "MIT", :file => "FILE_LICENSE" }
  s.author = {
    'KoppaSoft' => 'contact@koppasoft.com'
  }
  s.platform     = :ios, "9.0"
  s.source = { :http => "http://shared.koppasoft.com/understitiel/SDK/iOS/v#{s.version}/undertitiel-ios-sdk-v#{s.version}.zip" }
